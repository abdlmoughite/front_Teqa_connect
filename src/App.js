  ...
  return (
    <div className="App bgt-black">
      <Routes>
        ...
        <Route path="/ClientDetailedScoring" element={<ClientDetailedScoring/>} />
        <Route path="/Create_compte" element={<Create_compte/>} />


        {/* confirmation */}

        <Route path="/dashboard_counfirmation" element={<Dashboard_counfirmation/>} />
        <Route path="/commandes_counfirmation" element={<Commandes_confirmation/>} />
        <Route path="/reclamation_counfirmation" element={<Reclamation_counfirmation/>} />
        <Route path="/liste_commandes_counfirmation" element={<Liste_commandes_counfirmation/>} />
